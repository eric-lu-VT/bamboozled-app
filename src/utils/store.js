...
const ActionTypes = {
  ...
  CHANGE_CUR_CARD_SELECTED: 'CHANGE_CUR_CARD_SELECTED',
  ...
  USE_CARD_SEND: 'USE_CARD_SEND',
  USE_CARD_SEND_SUCCESS: 'USE_CARD_SEND_SUCCESS',
  USE_CARD_SEND_FAIL: 'USE_CARD_SEND_FAIL',
  USE_CARD_RECEIVE_SUCCESS: 'USE_CARD_RECEIVE_SUCCESS',
  USE_CARD_RECEIVE_FAIL: 'USE_CARD_RECEIVE_FAIL',
